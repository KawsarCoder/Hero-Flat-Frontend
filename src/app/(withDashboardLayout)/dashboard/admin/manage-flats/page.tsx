    ...
    <>
      <section>
        <CommonDashboardHeaderTitle
          mainTitle="Manage All Flats"
          secondaryTitle="You can manage all flat"
        />
        ...
        <div className="relative overflow-x-auto shadow-md sm:rounded-sm">
          <table className="w-full text-sm text-left rtl:text-right text-gray-500 font-Ubuntu ">
            <thead className="text-xs text-black uppercase bg-purple-300 text-center ">
              <tr>
                    ...
                    <td className="px-6 py-4 flex justify-between gap-2 text-gray-700">
                      ...
                      <Link href={`/flatDetails/${item?.id}`}>
                        <svg
                          ...
                          strokeWidth={1.5}
                          stroke="currentColor"
                          className=" h-8 w-8  rounded-md bg-purple-200 text-purple-600 px-2 py-1"
                        >
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
