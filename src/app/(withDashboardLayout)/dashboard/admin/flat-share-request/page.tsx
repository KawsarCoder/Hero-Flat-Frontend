  ...
  return (
    <section>
      <CommonDashboardHeaderTitle
        ...
        secondaryTitle="You can manage all flat request"
      />
      <div className="w-full mb-8 overflow-hidden rounded-lg shadow-xs mt-10 border-b border-gray-400">
        <div className="w-full overflow-x-auto">
          <table className="w-full whitespace-no-wrap">
            <thead>
              <tr className="text-xs font-semibold tracking-wide text-gray-800 font-Ubuntu text-center uppercase border-b bg-purple-300">
                    ...
                    <td className="px-4 py-3 text-xs">
                      <span
                        className={`px-2 py-1 text-xs font-semibold ${
                          item?.status === "BOOKED" && "bg-green-500 text-white"
                        } ${
                          item?.status === "PENDING" &&
      ...
      {/* <div className=" text-xs font-semibold tracking-wide text-gray-800 uppercase border-t font-Ubuntu border-gray-400 bg-gray-50 "></div> */}
    </section>
  );
}
